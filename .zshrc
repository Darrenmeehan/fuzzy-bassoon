...
# Heaviliy based on configuration from Kali Linux 20.03 
# https://gitlab.com/kalilinux/packages/kali-defaults/-/blob/kali/master/.zshrc
# and https://scriptingosx.com/2019/06/moving-to-zsh/
#
#
######################################################
...
HISTFILE=${ZDOTDIR:-$HOME}/.zsh_history   # Save history to a file when it exits
...
if [ "$color_prompt" = yes ]; then
    ...
    # FIXME Move reference of zsh-syntax-highlighting.zsh to variable
